...
class NewsPagingAdapter : PagingDataAdapter<Weather, NewsPagingAdapter.NewsViewHolder>(WeatherEntityComparator) {
    ...
    companion object {
        val WeatherEntityComparator = object : DiffUtil.ItemCallback<Weather>() {
